...
A tiny Mac OS INIT that backports one of Mac OS 8's nicest little Finder
...
and #129 in the INIT. Open the built extension in ResEdit and edit those two
resources to localize it — no recompiling needed.

## Building from source

This is a Symantec C++ (THINK C-era) project — `TodaysTheDay.π` is the
...
to materialize the real, IDE-usable project and resource files.
